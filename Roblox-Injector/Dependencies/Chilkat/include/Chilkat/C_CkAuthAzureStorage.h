...
CK_C_VISIBLE_PUBLIC HCkAuthAzureStorage CkAuthAzureStorage_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC void CkAuthAzureStorage_Noop(HCkAuthAzureStorage cHandle);
#endif
