...
class CK_VISIBLE_PUBLIC CkFileAccessW  : public CkWideCharBase
{
	...
	// 
	bool GetFileTimeStr(const wchar_t *path, int which, CkString &outStr);
	// Returns one of the following times for a file:0: Last-modified
	// 1: Last-access
	// 2: Creation
	// The path argument indicates which time to return. The values can be 0, 1, or 2.
	...
	// The time is returned in the ISO 8601 timestamp format: YYYY-MM-DDTHH:MM:SSZ.
	// 
	const wchar_t *getFileTimeStr(const wchar_t *path, int which);
	// Returns one of the following times for a file:0: Last-modified
	// 1: Last-access
	// 2: Creation
	// The path argument indicates which time to return. The values can be 0, 1, or 2.
	...
	// The time is returned in the ISO 8601 timestamp format: YYYY-MM-DDTHH:MM:SSZ.
	// 
	const wchar_t *fileTimeStr(const wchar_t *path, int which);
