...
CK_C_VISIBLE_PUBLIC void CkImapW_getSortCriteria(HCkImapW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void  CkImapW_putSortCriteria(HCkImapW cHandle, const wchar_t *newVal);
CK_C_VISIBLE_PUBLIC const wchar_t *CkImapW_sortCriteria(HCkImapW cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkImapW_AddPfxSourceBd(HCkImapW cHandle, HCkBinDataW bd, const wchar_t *password);
...
CK_C_VISIBLE_PUBLIC BOOL CkImapW_FetchChunk2(HCkImapW cHandle, int seqnum, int count, HCkMessageSetW failedSet, HCkMessageSetW fetchedSet, HCkEmailBundleW bundle);
CK_C_VISIBLE_PUBLIC HCkTaskW CkImapW_FetchChunk2Async(HCkImapW cHandle, int seqnum, int count, HCkMessageSetW failedSet, HCkMessageSetW fetchedSet, HCkEmailBundleW bundle);
CK_C_VISIBLE_PUBLIC BOOL CkImapW_FetchEmail(HCkImapW cHandle, BOOL headerOnly, unsigned long msgId, BOOL bUid, HCkEmailW email);
CK_C_VISIBLE_PUBLIC HCkTaskW CkImapW_FetchEmailAsync(HCkImapW cHandle, BOOL headerOnly, unsigned long msgId, BOOL bUid, HCkEmailW email);
...
CK_C_VISIBLE_PUBLIC BOOL CkImapW_FetchMsgSet(HCkImapW cHandle, BOOL headersOnly, HCkMessageSetW msgSet, HCkEmailBundleW bundle);
CK_C_VISIBLE_PUBLIC HCkTaskW CkImapW_FetchMsgSetAsync(HCkImapW cHandle, BOOL headersOnly, HCkMessageSetW msgSet, HCkEmailBundleW bundle);
CK_C_VISIBLE_PUBLIC BOOL CkImapW_FetchRange(HCkImapW cHandle, BOOL headersOnly, int seqnum, int count, HCkEmailBundleW bundle);
CK_C_VISIBLE_PUBLIC HCkTaskW CkImapW_FetchRangeAsync(HCkImapW cHandle, BOOL headersOnly, int seqnum, int count, HCkEmailBundleW bundle);
...
CK_C_VISIBLE_PUBLIC BOOL CkImapW_GetServerCert(HCkImapW cHandle, HCkCertW cert);
...
CK_C_VISIBLE_PUBLIC BOOL CkImapW_MbxList(HCkImapW cHandle, BOOL subscribed, const wchar_t *reference, const wchar_t *mbxPattern, HCkMailboxesW mboxes);
CK_C_VISIBLE_PUBLIC HCkTaskW CkImapW_MbxListAsync(HCkImapW cHandle, BOOL subscribed, const wchar_t *reference, const wchar_t *mbxPattern, HCkMailboxesW mboxes);
...
CK_C_VISIBLE_PUBLIC BOOL CkImapW_QueryMbx(HCkImapW cHandle, const wchar_t *criteria, BOOL bUid, HCkMessageSetW msgSet);
CK_C_VISIBLE_PUBLIC HCkTaskW CkImapW_QueryMbxAsync(HCkImapW cHandle, const wchar_t *criteria, BOOL bUid, HCkMessageSetW msgSet);
CK_C_VISIBLE_PUBLIC BOOL CkImapW_QueryThread(HCkImapW cHandle, const wchar_t *threadAlg, const wchar_t *searchCriteria, BOOL bUid, HCkJsonObjectW json);
CK_C_VISIBLE_PUBLIC HCkTaskW CkImapW_QueryThreadAsync(HCkImapW cHandle, const wchar_t *threadAlg, const wchar_t *searchCriteria, BOOL bUid, HCkJsonObjectW json);
CK_C_VISIBLE_PUBLIC BOOL CkImapW_RawCommandBd(HCkImapW cHandle, HCkBinDataW bdCmd, HCkBinDataW bdResp);
CK_C_VISIBLE_PUBLIC HCkTaskW CkImapW_RawCommandBdAsync(HCkImapW cHandle, HCkBinDataW bdCmd, HCkBinDataW bdResp);
