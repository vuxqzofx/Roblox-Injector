...
CK_C_VISIBLE_PUBLIC void CkSFtpW_GetLastJsonData(HCkSFtpW cHandle, HCkJsonObjectW json);
CK_C_VISIBLE_PUBLIC void CkSFtpW_GetSyncedFiles(HCkSFtpW cHandle, HCkStringTableW strTab);
...
CK_C_VISIBLE_PUBLIC BOOL CkSFtpW_ReadDirListing(HCkSFtpW cHandle, const wchar_t *handle, HCkSFtpDirW dirObj);
CK_C_VISIBLE_PUBLIC HCkTaskW CkSFtpW_ReadDirListingAsync(HCkSFtpW cHandle, const wchar_t *handle, HCkSFtpDirW dirObj);
...
CK_C_VISIBLE_PUBLIC BOOL CkSFtpW_SetAllowedAlgorithms(HCkSFtpW cHandle, HCkJsonObjectW json);
