...
CK_C_VISIBLE_PUBLIC HCkSecureString CkSecureString_Create2(int progLang);
CK_C_VISIBLE_PUBLIC void CkSecureString_Dispose(HCkSecureString handle);
CK_C_VISIBLE_PUBLIC void CkSecureString_getDebugLogFilePath(HCkSecureString cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void CkSecureString_putDebugLogFilePath(HCkSecureString cHandle, const char *newVal);
CK_C_VISIBLE_PUBLIC const char *CkSecureString_debugLogFilePath(HCkSecureString cHandle);
CK_C_VISIBLE_PUBLIC void CkSecureString_getLastErrorHtml(HCkSecureString cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const char *CkSecureString_lastErrorHtml(HCkSecureString cHandle);
CK_C_VISIBLE_PUBLIC void CkSecureString_getLastErrorText(HCkSecureString cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const char *CkSecureString_lastErrorText(HCkSecureString cHandle);
CK_C_VISIBLE_PUBLIC void CkSecureString_getLastErrorXml(HCkSecureString cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const char *CkSecureString_lastErrorXml(HCkSecureString cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkSecureString_getVerboseLogging(HCkSecureString cHandle);
CK_C_VISIBLE_PUBLIC void CkSecureString_putVerboseLogging(HCkSecureString cHandle, BOOL newVal);
CK_C_VISIBLE_PUBLIC void CkSecureString_getVersion(HCkSecureString cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const char *CkSecureString_version(HCkSecureString cHandle);
