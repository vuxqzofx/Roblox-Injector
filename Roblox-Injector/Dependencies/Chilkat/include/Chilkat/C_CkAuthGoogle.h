...
CK_C_VISIBLE_PUBLIC HCkAuthGoogle CkAuthGoogle_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC BOOL CkAuthGoogle_AddClaims(HCkAuthGoogle cHandle, HCkJsonObject json);
