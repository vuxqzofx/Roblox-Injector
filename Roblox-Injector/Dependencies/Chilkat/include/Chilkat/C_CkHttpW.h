...
CK_C_VISIBLE_PUBLIC BOOL CkHttpW_getRequireHostnameMatch(HCkHttpW cHandle);
CK_C_VISIBLE_PUBLIC void  CkHttpW_putRequireHostnameMatch(HCkHttpW cHandle, BOOL newVal);
...
CK_C_VISIBLE_PUBLIC BOOL CkHttpW_DownloadAppend(HCkHttpW cHandle, const wchar_t *url, const wchar_t *appendToPath);
CK_C_VISIBLE_PUBLIC HCkTaskW CkHttpW_DownloadAppendAsync(HCkHttpW cHandle, const wchar_t *url, const wchar_t *appendToPath);
...
CK_C_VISIBLE_PUBLIC void CkHttpW_GetLastJsonData(HCkHttpW cHandle, HCkJsonObjectW json);
...
CK_C_VISIBLE_PUBLIC BOOL CkHttpW_GetServerCert(HCkHttpW cHandle, const wchar_t *domain, int port, HCkCertW cert);
CK_C_VISIBLE_PUBLIC HCkTaskW CkHttpW_GetServerCertAsync(HCkHttpW cHandle, const wchar_t *domain, int port, HCkCertW cert);
...
CK_C_VISIBLE_PUBLIC BOOL CkHttpW_HttpBd(HCkHttpW cHandle, const wchar_t *verb, const wchar_t *url, HCkBinDataW bd, const wchar_t *contentType, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC HCkTaskW CkHttpW_HttpBdAsync(HCkHttpW cHandle, const wchar_t *verb, const wchar_t *url, HCkBinDataW bd, const wchar_t *contentType, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC BOOL CkHttpW_HttpBinary(HCkHttpW cHandle, const wchar_t *verb, const wchar_t *url, HCkByteData byteData, const wchar_t *contentType, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC HCkTaskW CkHttpW_HttpBinaryAsync(HCkHttpW cHandle, const wchar_t *verb, const wchar_t *url, HCkByteData byteData, const wchar_t *contentType, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC BOOL CkHttpW_HttpFile(HCkHttpW cHandle, const wchar_t *verb, const wchar_t *url, const wchar_t *localFilePath, const wchar_t *contentType, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC HCkTaskW CkHttpW_HttpFileAsync(HCkHttpW cHandle, const wchar_t *verb, const wchar_t *url, const wchar_t *localFilePath, const wchar_t *contentType, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC BOOL CkHttpW_HttpJson(HCkHttpW cHandle, const wchar_t *verb, const wchar_t *url, HCkJsonObjectW json, const wchar_t *contentType, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC HCkTaskW CkHttpW_HttpJsonAsync(HCkHttpW cHandle, const wchar_t *verb, const wchar_t *url, HCkJsonObjectW json, const wchar_t *contentType, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC BOOL CkHttpW_HttpNoBody(HCkHttpW cHandle, const wchar_t *verb, const wchar_t *url, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC HCkTaskW CkHttpW_HttpNoBodyAsync(HCkHttpW cHandle, const wchar_t *verb, const wchar_t *url, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC BOOL CkHttpW_HttpParams(HCkHttpW cHandle, const wchar_t *verb, const wchar_t *url, HCkJsonObjectW json, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC HCkTaskW CkHttpW_HttpParamsAsync(HCkHttpW cHandle, const wchar_t *verb, const wchar_t *url, HCkJsonObjectW json, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC BOOL CkHttpW_HttpReq(HCkHttpW cHandle, const wchar_t *url, HCkHttpRequestW request, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC HCkTaskW CkHttpW_HttpReqAsync(HCkHttpW cHandle, const wchar_t *url, HCkHttpRequestW request, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC BOOL CkHttpW_HttpSb(HCkHttpW cHandle, const wchar_t *verb, const wchar_t *url, HCkStringBuilderW sb, const wchar_t *charset, const wchar_t *contentType, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC HCkTaskW CkHttpW_HttpSbAsync(HCkHttpW cHandle, const wchar_t *verb, const wchar_t *url, HCkStringBuilderW sb, const wchar_t *charset, const wchar_t *contentType, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC BOOL CkHttpW_HttpSReq(HCkHttpW cHandle, const wchar_t *domain, int port, BOOL ssl, HCkHttpRequestW request, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC HCkTaskW CkHttpW_HttpSReqAsync(HCkHttpW cHandle, const wchar_t *domain, int port, BOOL ssl, HCkHttpRequestW request, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC BOOL CkHttpW_HttpStr(HCkHttpW cHandle, const wchar_t *verb, const wchar_t *url, const wchar_t *bodyStr, const wchar_t *charset, const wchar_t *contentType, HCkHttpResponseW response);
CK_C_VISIBLE_PUBLIC HCkTaskW CkHttpW_HttpStrAsync(HCkHttpW cHandle, const wchar_t *verb, const wchar_t *url, const wchar_t *bodyStr, const wchar_t *charset, const wchar_t *contentType, HCkHttpResponseW response);
...
CK_C_VISIBLE_PUBLIC BOOL CkHttpW_S3_DeleteObjects(HCkHttpW cHandle, const wchar_t *bucketName, HCkStringTableW objectNames, HCkJsonObjectW jsonResponse);
CK_C_VISIBLE_PUBLIC HCkTaskW CkHttpW_S3_DeleteObjectsAsync(HCkHttpW cHandle, const wchar_t *bucketName, HCkStringTableW objectNames, HCkJsonObjectW jsonResponse);
