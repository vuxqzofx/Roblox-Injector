...
CK_C_VISIBLE_PUBLIC HCkGzip CkGzip_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC BOOL CkGzip_CompressFileBd(HCkGzip cHandle, const char *filePath, HCkBinData bd);
CK_C_VISIBLE_PUBLIC HCkTask CkGzip_CompressFileBdAsync(HCkGzip cHandle, const char *filePath, HCkBinData bd);
...
CK_C_VISIBLE_PUBLIC BOOL CkGzip_CompressSb(HCkGzip cHandle, HCkStringBuilder sb, const char *charset, HCkBinData bd);
CK_C_VISIBLE_PUBLIC HCkTask CkGzip_CompressSbAsync(HCkGzip cHandle, HCkStringBuilder sb, const char *charset, HCkBinData bd);
...
CK_C_VISIBLE_PUBLIC BOOL CkGzip_IsGzip(HCkGzip cHandle, HCkBinData bd);
...
CK_C_VISIBLE_PUBLIC BOOL CkGzip_SetExtraData(HCkGzip cHandle, const char *encodedData, const char *encoding);
...
CK_C_VISIBLE_PUBLIC BOOL CkGzip_UncompressBdToFile(HCkGzip cHandle, HCkBinData bd, const char *filePath);
CK_C_VISIBLE_PUBLIC HCkTask CkGzip_UncompressBdToFileAsync(HCkGzip cHandle, HCkBinData bd, const char *filePath);
