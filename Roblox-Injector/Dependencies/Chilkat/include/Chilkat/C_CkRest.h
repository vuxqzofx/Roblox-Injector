...
CK_C_VISIBLE_PUBLIC HCkRest CkRest_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC void CkRest_getLastRedirectUrl(HCkRest cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const char *CkRest_lastRedirectUrl(HCkRest cHandle);
...
CK_C_VISIBLE_PUBLIC void CkRest_GetLastJsonData(HCkRest cHandle, HCkJsonObject json);
...
CK_C_VISIBLE_PUBLIC int CkRest_ReadRespChunkBd(HCkRest cHandle, int minSize, HCkBinData bd);
CK_C_VISIBLE_PUBLIC HCkTask CkRest_ReadRespChunkBdAsync(HCkRest cHandle, int minSize, HCkBinData bd);
