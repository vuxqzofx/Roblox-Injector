...
CK_C_VISIBLE_PUBLIC HCkHashtable CkHashtable_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC void CkHashtable_getDebugLogFilePath(HCkHashtable cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void CkHashtable_putDebugLogFilePath(HCkHashtable cHandle, const char *newVal);
CK_C_VISIBLE_PUBLIC const char *CkHashtable_debugLogFilePath(HCkHashtable cHandle);
CK_C_VISIBLE_PUBLIC void CkHashtable_getLastErrorHtml(HCkHashtable cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const char *CkHashtable_lastErrorHtml(HCkHashtable cHandle);
CK_C_VISIBLE_PUBLIC void CkHashtable_getLastErrorText(HCkHashtable cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const char *CkHashtable_lastErrorText(HCkHashtable cHandle);
CK_C_VISIBLE_PUBLIC void CkHashtable_getLastErrorXml(HCkHashtable cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const char *CkHashtable_lastErrorXml(HCkHashtable cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkHashtable_getVerboseLogging(HCkHashtable cHandle);
CK_C_VISIBLE_PUBLIC void CkHashtable_putVerboseLogging(HCkHashtable cHandle, BOOL newVal);
CK_C_VISIBLE_PUBLIC void CkHashtable_getVersion(HCkHashtable cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const char *CkHashtable_version(HCkHashtable cHandle);
