...
CK_C_VISIBLE_PUBLIC BOOL CkOAuth2W_getOob(HCkOAuth2W cHandle);
CK_C_VISIBLE_PUBLIC void  CkOAuth2W_putOob(HCkOAuth2W cHandle, BOOL newVal);
...
CK_C_VISIBLE_PUBLIC BOOL CkOAuth2W_ExchangeCodeForToken(HCkOAuth2W cHandle, const wchar_t *code);
CK_C_VISIBLE_PUBLIC HCkTaskW CkOAuth2W_ExchangeCodeForTokenAsync(HCkOAuth2W cHandle, const wchar_t *code);
CK_C_VISIBLE_PUBLIC BOOL CkOAuth2W_GetAccessTokenResponseSb(HCkOAuth2W cHandle, HCkStringBuilderW sb);
...
CK_C_VISIBLE_PUBLIC BOOL CkOAuth2W_LaunchBrowser(HCkOAuth2W cHandle, const wchar_t *url);
