...
CK_C_VISIBLE_PUBLIC HCkImap CkImap_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC void CkImap_getSortCriteria(HCkImap cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void CkImap_putSortCriteria(HCkImap cHandle, const char *newVal);
CK_C_VISIBLE_PUBLIC const char *CkImap_sortCriteria(HCkImap cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkImap_AddPfxSourceBd(HCkImap cHandle, HCkBinData bd, const char *password);
...
CK_C_VISIBLE_PUBLIC BOOL CkImap_FetchChunk2(HCkImap cHandle, int seqnum, int count, HCkMessageSet failedSet, HCkMessageSet fetchedSet, HCkEmailBundle bundle);
CK_C_VISIBLE_PUBLIC HCkTask CkImap_FetchChunk2Async(HCkImap cHandle, int seqnum, int count, HCkMessageSet failedSet, HCkMessageSet fetchedSet, HCkEmailBundle bundle);
CK_C_VISIBLE_PUBLIC BOOL CkImap_FetchEmail(HCkImap cHandle, BOOL headerOnly, unsigned long msgId, BOOL bUid, HCkEmail email);
CK_C_VISIBLE_PUBLIC HCkTask CkImap_FetchEmailAsync(HCkImap cHandle, BOOL headerOnly, unsigned long msgId, BOOL bUid, HCkEmail email);
...
CK_C_VISIBLE_PUBLIC BOOL CkImap_FetchMsgSet(HCkImap cHandle, BOOL headersOnly, HCkMessageSet msgSet, HCkEmailBundle bundle);
CK_C_VISIBLE_PUBLIC HCkTask CkImap_FetchMsgSetAsync(HCkImap cHandle, BOOL headersOnly, HCkMessageSet msgSet, HCkEmailBundle bundle);
CK_C_VISIBLE_PUBLIC BOOL CkImap_FetchRange(HCkImap cHandle, BOOL headersOnly, int seqnum, int count, HCkEmailBundle bundle);
CK_C_VISIBLE_PUBLIC HCkTask CkImap_FetchRangeAsync(HCkImap cHandle, BOOL headersOnly, int seqnum, int count, HCkEmailBundle bundle);
...
CK_C_VISIBLE_PUBLIC BOOL CkImap_GetServerCert(HCkImap cHandle, HCkCert cert);
...
CK_C_VISIBLE_PUBLIC BOOL CkImap_MbxList(HCkImap cHandle, BOOL subscribed, const char *reference, const char *mbxPattern, HCkMailboxes mboxes);
CK_C_VISIBLE_PUBLIC HCkTask CkImap_MbxListAsync(HCkImap cHandle, BOOL subscribed, const char *reference, const char *mbxPattern, HCkMailboxes mboxes);
...
CK_C_VISIBLE_PUBLIC BOOL CkImap_QueryMbx(HCkImap cHandle, const char *criteria, BOOL bUid, HCkMessageSet msgSet);
CK_C_VISIBLE_PUBLIC HCkTask CkImap_QueryMbxAsync(HCkImap cHandle, const char *criteria, BOOL bUid, HCkMessageSet msgSet);
CK_C_VISIBLE_PUBLIC BOOL CkImap_QueryThread(HCkImap cHandle, const char *threadAlg, const char *searchCriteria, BOOL bUid, HCkJsonObject json);
CK_C_VISIBLE_PUBLIC HCkTask CkImap_QueryThreadAsync(HCkImap cHandle, const char *threadAlg, const char *searchCriteria, BOOL bUid, HCkJsonObject json);
CK_C_VISIBLE_PUBLIC BOOL CkImap_RawCommandBd(HCkImap cHandle, HCkBinData bdCmd, HCkBinData bdResp);
CK_C_VISIBLE_PUBLIC HCkTask CkImap_RawCommandBdAsync(HCkImap cHandle, HCkBinData bdCmd, HCkBinData bdResp);
