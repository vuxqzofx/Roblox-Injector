...
CK_C_VISIBLE_PUBLIC HCkSFtpFile CkSFtpFile_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC void CkSFtpFile_getDebugLogFilePath(HCkSFtpFile cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void CkSFtpFile_putDebugLogFilePath(HCkSFtpFile cHandle, const char *newVal);
CK_C_VISIBLE_PUBLIC const char *CkSFtpFile_debugLogFilePath(HCkSFtpFile cHandle);
...
CK_C_VISIBLE_PUBLIC void CkSFtpFile_getLastErrorHtml(HCkSFtpFile cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const char *CkSFtpFile_lastErrorHtml(HCkSFtpFile cHandle);
CK_C_VISIBLE_PUBLIC void CkSFtpFile_getLastErrorText(HCkSFtpFile cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const char *CkSFtpFile_lastErrorText(HCkSFtpFile cHandle);
CK_C_VISIBLE_PUBLIC void CkSFtpFile_getLastErrorXml(HCkSFtpFile cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const char *CkSFtpFile_lastErrorXml(HCkSFtpFile cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkSFtpFile_getVerboseLogging(HCkSFtpFile cHandle);
CK_C_VISIBLE_PUBLIC void CkSFtpFile_putVerboseLogging(HCkSFtpFile cHandle, BOOL newVal);
CK_C_VISIBLE_PUBLIC void CkSFtpFile_getVersion(HCkSFtpFile cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const char *CkSFtpFile_version(HCkSFtpFile cHandle);
