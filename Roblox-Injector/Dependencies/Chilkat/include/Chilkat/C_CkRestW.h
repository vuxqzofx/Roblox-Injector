...
CK_C_VISIBLE_PUBLIC void CkRestW_getLastRedirectUrl(HCkRestW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const wchar_t *CkRestW_lastRedirectUrl(HCkRestW cHandle);
...
CK_C_VISIBLE_PUBLIC void CkRestW_GetLastJsonData(HCkRestW cHandle, HCkJsonObjectW json);
...
CK_C_VISIBLE_PUBLIC int CkRestW_ReadRespChunkBd(HCkRestW cHandle, int minSize, HCkBinDataW bd);
CK_C_VISIBLE_PUBLIC HCkTaskW CkRestW_ReadRespChunkBdAsync(HCkRestW cHandle, int minSize, HCkBinDataW bd);
