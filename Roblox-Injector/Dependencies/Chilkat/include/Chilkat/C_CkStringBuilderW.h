...
CK_C_VISIBLE_PUBLIC void CkStringBuilderW_getDebugLogFilePath(HCkStringBuilderW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void  CkStringBuilderW_putDebugLogFilePath(HCkStringBuilderW cHandle, const wchar_t *newVal);
CK_C_VISIBLE_PUBLIC const wchar_t *CkStringBuilderW_debugLogFilePath(HCkStringBuilderW cHandle);
CK_C_VISIBLE_PUBLIC BOOL CkStringBuilderW_getHasEmojis(HCkStringBuilderW cHandle);
...
CK_C_VISIBLE_PUBLIC void CkStringBuilderW_getLastErrorHtml(HCkStringBuilderW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const wchar_t *CkStringBuilderW_lastErrorHtml(HCkStringBuilderW cHandle);
CK_C_VISIBLE_PUBLIC void CkStringBuilderW_getLastErrorText(HCkStringBuilderW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const wchar_t *CkStringBuilderW_lastErrorText(HCkStringBuilderW cHandle);
CK_C_VISIBLE_PUBLIC void CkStringBuilderW_getLastErrorXml(HCkStringBuilderW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const wchar_t *CkStringBuilderW_lastErrorXml(HCkStringBuilderW cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkStringBuilderW_getVerboseLogging(HCkStringBuilderW cHandle);
CK_C_VISIBLE_PUBLIC void  CkStringBuilderW_putVerboseLogging(HCkStringBuilderW cHandle, BOOL newVal);
CK_C_VISIBLE_PUBLIC void CkStringBuilderW_getVersion(HCkStringBuilderW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const wchar_t *CkStringBuilderW_version(HCkStringBuilderW cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkStringBuilderW_AppendUuid7(HCkStringBuilderW cHandle, BOOL lowerCase);
...
CK_C_VISIBLE_PUBLIC BOOL CkStringBuilderW_GetRangeSb(HCkStringBuilderW cHandle, int startIndex, int numChars, BOOL removeFlag, HCkStringBuilderW sb);
...
CK_C_VISIBLE_PUBLIC BOOL CkStringBuilderW_MarkdownToHtml(HCkStringBuilderW cHandle, HCkJsonObjectW options, HCkStringBuilderW sbHtml);
CK_C_VISIBLE_PUBLIC BOOL CkStringBuilderW_MaskQuotedStrings(HCkStringBuilderW cHandle, const wchar_t *maskChar, int quoteType, HCkStringTableW maskedStrings);
...
CK_C_VISIBLE_PUBLIC int CkStringBuilderW_RegexMatch(HCkStringBuilderW cHandle, const wchar_t *pattern, HCkJsonObjectW json, int timeoutMs);
CK_C_VISIBLE_PUBLIC BOOL CkStringBuilderW_RegexReplace(HCkStringBuilderW cHandle, HCkJsonObjectW json);
...
CK_C_VISIBLE_PUBLIC void CkStringBuilderW_RemoveEmojis(HCkStringBuilderW cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkStringBuilderW_RestoreMaskedStrings(HCkStringBuilderW cHandle, int quoteType, HCkStringTableW maskedStrings);
