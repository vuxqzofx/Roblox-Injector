...
CK_C_VISIBLE_PUBLIC HCkBz2 CkBz2_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC BOOL CkBz2_CompressBd(HCkBz2 cHandle, HCkBinData bd);
CK_C_VISIBLE_PUBLIC HCkTask CkBz2_CompressBdAsync(HCkBz2 cHandle, HCkBinData bd);
...
CK_C_VISIBLE_PUBLIC BOOL CkBz2_UncompressBd(HCkBz2 cHandle, HCkBinData bd);
CK_C_VISIBLE_PUBLIC HCkTask CkBz2_UncompressBdAsync(HCkBz2 cHandle, HCkBinData bd);
