...
CK_C_VISIBLE_PUBLIC unsigned long CkFtp2W_getCurBytesReceived(HCkFtp2W cHandle);
CK_C_VISIBLE_PUBLIC __int64 CkFtp2W_getCurBytesReceived64(HCkFtp2W cHandle);
CK_C_VISIBLE_PUBLIC void CkFtp2W_getCurBytesReceivedStr(HCkFtp2W cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const wchar_t *CkFtp2W_curBytesReceivedStr(HCkFtp2W cHandle);
CK_C_VISIBLE_PUBLIC unsigned long CkFtp2W_getCurBytesSent(HCkFtp2W cHandle);
CK_C_VISIBLE_PUBLIC __int64 CkFtp2W_getCurBytesSent64(HCkFtp2W cHandle);
CK_C_VISIBLE_PUBLIC void CkFtp2W_getCurBytesSentStr(HCkFtp2W cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const wchar_t *CkFtp2W_curBytesSentStr(HCkFtp2W cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkFtp2W_AppendFileBd(HCkFtp2W cHandle, const wchar_t *remoteFilename, HCkBinDataW bd);
CK_C_VISIBLE_PUBLIC HCkTaskW CkFtp2W_AppendFileBdAsync(HCkFtp2W cHandle, const wchar_t *remoteFilename, HCkBinDataW bd);
...
CK_C_VISIBLE_PUBLIC BOOL CkFtp2W_AppendFileSb(HCkFtp2W cHandle, const wchar_t *remoteFilename, HCkStringBuilderW sb, const wchar_t *charset);
CK_C_VISIBLE_PUBLIC HCkTaskW CkFtp2W_AppendFileSbAsync(HCkFtp2W cHandle, const wchar_t *remoteFilename, HCkStringBuilderW sb, const wchar_t *charset);
...
CK_C_VISIBLE_PUBLIC BOOL CkFtp2W_GetServerCert(HCkFtp2W cHandle, HCkCertW cert);
...
CK_C_VISIBLE_PUBLIC void CkFtp2W_GetSyncedFiles(HCkFtp2W cHandle, HCkStringTableW strTable);
