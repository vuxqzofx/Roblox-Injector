...
CK_C_VISIBLE_PUBLIC HCkFtp2 CkFtp2_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC unsigned long CkFtp2_getCurBytesReceived(HCkFtp2 cHandle);
CK_C_VISIBLE_PUBLIC __int64 CkFtp2_getCurBytesReceived64(HCkFtp2 cHandle);
CK_C_VISIBLE_PUBLIC void CkFtp2_getCurBytesReceivedStr(HCkFtp2 cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const char *CkFtp2_curBytesReceivedStr(HCkFtp2 cHandle);
CK_C_VISIBLE_PUBLIC unsigned long CkFtp2_getCurBytesSent(HCkFtp2 cHandle);
CK_C_VISIBLE_PUBLIC __int64 CkFtp2_getCurBytesSent64(HCkFtp2 cHandle);
CK_C_VISIBLE_PUBLIC void CkFtp2_getCurBytesSentStr(HCkFtp2 cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const char *CkFtp2_curBytesSentStr(HCkFtp2 cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkFtp2_AppendFileBd(HCkFtp2 cHandle, const char *remoteFilename, HCkBinData bd);
CK_C_VISIBLE_PUBLIC HCkTask CkFtp2_AppendFileBdAsync(HCkFtp2 cHandle, const char *remoteFilename, HCkBinData bd);
...
CK_C_VISIBLE_PUBLIC BOOL CkFtp2_AppendFileSb(HCkFtp2 cHandle, const char *remoteFilename, HCkStringBuilder sb, const char *charset);
CK_C_VISIBLE_PUBLIC HCkTask CkFtp2_AppendFileSbAsync(HCkFtp2 cHandle, const char *remoteFilename, HCkStringBuilder sb, const char *charset);
...
CK_C_VISIBLE_PUBLIC BOOL CkFtp2_GetServerCert(HCkFtp2 cHandle, HCkCert cert);
...
CK_C_VISIBLE_PUBLIC void CkFtp2_GetSyncedFiles(HCkFtp2 cHandle, HCkStringTable strTable);
