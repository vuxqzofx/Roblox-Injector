...
CK_C_VISIBLE_PUBLIC void CkJwsW_getUncommonOptions(HCkJwsW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void  CkJwsW_putUncommonOptions(HCkJwsW cHandle, const wchar_t *newVal);
CK_C_VISIBLE_PUBLIC const wchar_t *CkJwsW_uncommonOptions(HCkJwsW cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkJwsW_GetProtectedH(HCkJwsW cHandle, int index, HCkJsonObjectW json);
CK_C_VISIBLE_PUBLIC HCkJsonObjectW CkJwsW_GetProtectedHeader(HCkJwsW cHandle, int index);
CK_C_VISIBLE_PUBLIC BOOL CkJwsW_GetUnprotectedH(HCkJwsW cHandle, int index, HCkJsonObjectW json);
