...
CK_C_VISIBLE_PUBLIC BOOL CkEmailW_AddPfxSourceBd(HCkEmailW cHandle, HCkBinDataW bd, const wchar_t *password);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmailW_GetAttachedEmail(HCkEmailW cHandle, int index, HCkEmailW email);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmailW_GetDigestEmail(HCkEmailW cHandle, int index, HCkEmailW email);
CK_C_VISIBLE_PUBLIC HCkStringArrayW CkEmailW_GetDsnFinalRecipients(HCkEmailW cHandle);
CK_C_VISIBLE_PUBLIC BOOL CkEmailW_GetDsnInfo(HCkEmailW cHandle, HCkJsonObjectW json);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmailW_GetHtmlBodySb(HCkEmailW cHandle, BOOL inlineImageData, HCkStringBuilderW sb);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmailW_GetRelatedHeader(HCkEmailW cHandle, int index, const wchar_t *fieldName, HCkString outStr);
CK_C_VISIBLE_PUBLIC const wchar_t *CkEmailW_getRelatedHeader(HCkEmailW cHandle, int index, const wchar_t *fieldName);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmailW_LastDecryptCert(HCkEmailW cHandle, HCkCertW cert);
CK_C_VISIBLE_PUBLIC BOOL CkEmailW_LastSignerCert(HCkEmailW cHandle, int index, HCkCertW cert);
CK_C_VISIBLE_PUBLIC BOOL CkEmailW_LinkedDomains(HCkEmailW cHandle, HCkStringTableW domains);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmailW_MakeCopy(HCkEmailW cHandle, HCkEmailW destEmail);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmailW_SetBodyBd(HCkEmailW cHandle, HCkBinDataW bd, const wchar_t *contentType, const wchar_t *disposition, const wchar_t *filename);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmailW_ToDsn(HCkEmailW cHandle, const wchar_t *explanation, const wchar_t *statusFields, BOOL headerOnly, HCkEmailW dsnEmail);
CK_C_VISIBLE_PUBLIC BOOL CkEmailW_ToForward(HCkEmailW cHandle, HCkEmailW forward);
CK_C_VISIBLE_PUBLIC BOOL CkEmailW_ToMdn(HCkEmailW cHandle, const wchar_t *message, const wchar_t *statusFields, BOOL headerOnly, HCkEmailW mdn);
CK_C_VISIBLE_PUBLIC BOOL CkEmailW_ToReply(HCkEmailW cHandle, HCkEmailW reply);
