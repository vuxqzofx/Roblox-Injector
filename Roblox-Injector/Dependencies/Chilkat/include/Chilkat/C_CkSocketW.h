...
CK_C_VISIBLE_PUBLIC BOOL CkSocketW_AcceptNext(HCkSocketW cHandle, int maxWaitMs, HCkSocketW socket);
CK_C_VISIBLE_PUBLIC HCkTaskW CkSocketW_AcceptNextAsync(HCkSocketW cHandle, int maxWaitMs, HCkSocketW socket);
...
CK_C_VISIBLE_PUBLIC BOOL CkSocketW_DupSocket(HCkSocketW cHandle, HCkSocketW dest);
CK_C_VISIBLE_PUBLIC BOOL CkSocketW_GetAdaptersAddresses(HCkSocketW cHandle, HCkJsonObjectW json);
CK_C_VISIBLE_PUBLIC void CkSocketW_GetLastJsonData(HCkSocketW cHandle, HCkJsonObjectW json);
CK_C_VISIBLE_PUBLIC HCkCertW CkSocketW_GetMyCert(HCkSocketW cHandle);
CK_C_VISIBLE_PUBLIC BOOL CkSocketW_GetMyServerCert(HCkSocketW cHandle, HCkCertW cert);
CK_C_VISIBLE_PUBLIC BOOL CkSocketW_GetRcvdClientCert(HCkSocketW cHandle, int index, HCkCertW cert);
CK_C_VISIBLE_PUBLIC HCkCertW CkSocketW_GetReceivedClientCert(HCkSocketW cHandle, int index);
CK_C_VISIBLE_PUBLIC BOOL CkSocketW_GetServerCert(HCkSocketW cHandle, HCkCertW cert);
...
CK_C_VISIBLE_PUBLIC BOOL CkSocketW_ReceiveUntilMatchSb(HCkSocketW cHandle, const wchar_t *matchStr, HCkStringBuilderW sb);
CK_C_VISIBLE_PUBLIC HCkTaskW CkSocketW_ReceiveUntilMatchSbAsync(HCkSocketW cHandle, const wchar_t *matchStr, HCkStringBuilderW sb);
...
CK_C_VISIBLE_PUBLIC BOOL CkSocketW_SshNewChannel(HCkSocketW cHandle, const wchar_t *hostname, int port, BOOL ssl, int maxWaitMs, HCkSocketW channel);
CK_C_VISIBLE_PUBLIC HCkTaskW CkSocketW_SshNewChannelAsync(HCkSocketW cHandle, const wchar_t *hostname, int port, BOOL ssl, int maxWaitMs, HCkSocketW channel);
