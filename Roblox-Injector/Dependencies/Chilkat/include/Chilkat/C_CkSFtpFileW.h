...
CK_C_VISIBLE_PUBLIC void CkSFtpFileW_getDebugLogFilePath(HCkSFtpFileW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void  CkSFtpFileW_putDebugLogFilePath(HCkSFtpFileW cHandle, const wchar_t *newVal);
CK_C_VISIBLE_PUBLIC const wchar_t *CkSFtpFileW_debugLogFilePath(HCkSFtpFileW cHandle);
...
CK_C_VISIBLE_PUBLIC void CkSFtpFileW_getLastErrorHtml(HCkSFtpFileW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const wchar_t *CkSFtpFileW_lastErrorHtml(HCkSFtpFileW cHandle);
CK_C_VISIBLE_PUBLIC void CkSFtpFileW_getLastErrorText(HCkSFtpFileW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const wchar_t *CkSFtpFileW_lastErrorText(HCkSFtpFileW cHandle);
CK_C_VISIBLE_PUBLIC void CkSFtpFileW_getLastErrorXml(HCkSFtpFileW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const wchar_t *CkSFtpFileW_lastErrorXml(HCkSFtpFileW cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkSFtpFileW_getVerboseLogging(HCkSFtpFileW cHandle);
CK_C_VISIBLE_PUBLIC void  CkSFtpFileW_putVerboseLogging(HCkSFtpFileW cHandle, BOOL newVal);
CK_C_VISIBLE_PUBLIC void CkSFtpFileW_getVersion(HCkSFtpFileW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const wchar_t *CkSFtpFileW_version(HCkSFtpFileW cHandle);
