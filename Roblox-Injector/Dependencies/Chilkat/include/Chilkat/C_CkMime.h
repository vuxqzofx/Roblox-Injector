...
CK_C_VISIBLE_PUBLIC HCkMime CkMime_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC int CkMime_getNumDecryptCerts(HCkMime cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkMime_AddPfxSourceBd(HCkMime cHandle, HCkBinData bd, const char *password);
...
CK_C_VISIBLE_PUBLIC void CkMime_GetLastJsonData(HCkMime cHandle, HCkJsonObject json);
...
CK_C_VISIBLE_PUBLIC BOOL CkMime_LastDecryptCert(HCkMime cHandle, int index, HCkCert cert);
CK_C_VISIBLE_PUBLIC HCkJsonObject CkMime_LastJsonData(HCkMime cHandle);
CK_C_VISIBLE_PUBLIC BOOL CkMime_LastSignerCert(HCkMime cHandle, int index, HCkCert cert);
...
CK_C_VISIBLE_PUBLIC BOOL CkMime_PartAt(HCkMime cHandle, int index, HCkMime subPart);
CK_C_VISIBLE_PUBLIC BOOL CkMime_PartsToFiles(HCkMime cHandle, const char *path, HCkStringTable st);
...
CK_C_VISIBLE_PUBLIC BOOL CkMime_SetBodyBd(HCkMime cHandle, HCkBinData bd);
