...
class CK_VISIBLE_PUBLIC CkPfx  : public CkMultiByteBase
{
	...
	static CkPfx *createNew2(int progLang);
	...
	// base64 , hex .
	bool CertByLocalKeyId(const char *localKeyId, const char *encoding, CkCert &cert);
	...
	// keychain.
	bool ImportToKeychain(CkJsonObject &opts);
