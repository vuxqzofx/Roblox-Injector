...
CK_C_VISIBLE_PUBLIC HCkHttp CkHttp_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC BOOL CkHttp_getRequireHostnameMatch(HCkHttp cHandle);
CK_C_VISIBLE_PUBLIC void CkHttp_putRequireHostnameMatch(HCkHttp cHandle, BOOL newVal);
...
CK_C_VISIBLE_PUBLIC BOOL CkHttp_DownloadAppend(HCkHttp cHandle, const char *url, const char *appendToPath);
CK_C_VISIBLE_PUBLIC HCkTask CkHttp_DownloadAppendAsync(HCkHttp cHandle, const char *url, const char *appendToPath);
...
CK_C_VISIBLE_PUBLIC void CkHttp_GetLastJsonData(HCkHttp cHandle, HCkJsonObject json);
...
CK_C_VISIBLE_PUBLIC BOOL CkHttp_GetServerCert(HCkHttp cHandle, const char *domain, int port, HCkCert cert);
CK_C_VISIBLE_PUBLIC HCkTask CkHttp_GetServerCertAsync(HCkHttp cHandle, const char *domain, int port, HCkCert cert);
...
CK_C_VISIBLE_PUBLIC BOOL CkHttp_HttpBd(HCkHttp cHandle, const char *verb, const char *url, HCkBinData bd, const char *contentType, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC HCkTask CkHttp_HttpBdAsync(HCkHttp cHandle, const char *verb, const char *url, HCkBinData bd, const char *contentType, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC BOOL CkHttp_HttpBinary(HCkHttp cHandle, const char *verb, const char *url, HCkByteData byteData, const char *contentType, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC HCkTask CkHttp_HttpBinaryAsync(HCkHttp cHandle, const char *verb, const char *url, HCkByteData byteData, const char *contentType, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC BOOL CkHttp_HttpFile(HCkHttp cHandle, const char *verb, const char *url, const char *localFilePath, const char *contentType, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC HCkTask CkHttp_HttpFileAsync(HCkHttp cHandle, const char *verb, const char *url, const char *localFilePath, const char *contentType, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC BOOL CkHttp_HttpJson(HCkHttp cHandle, const char *verb, const char *url, HCkJsonObject json, const char *contentType, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC HCkTask CkHttp_HttpJsonAsync(HCkHttp cHandle, const char *verb, const char *url, HCkJsonObject json, const char *contentType, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC BOOL CkHttp_HttpNoBody(HCkHttp cHandle, const char *verb, const char *url, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC HCkTask CkHttp_HttpNoBodyAsync(HCkHttp cHandle, const char *verb, const char *url, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC BOOL CkHttp_HttpParams(HCkHttp cHandle, const char *verb, const char *url, HCkJsonObject json, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC HCkTask CkHttp_HttpParamsAsync(HCkHttp cHandle, const char *verb, const char *url, HCkJsonObject json, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC BOOL CkHttp_HttpReq(HCkHttp cHandle, const char *url, HCkHttpRequest request, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC HCkTask CkHttp_HttpReqAsync(HCkHttp cHandle, const char *url, HCkHttpRequest request, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC BOOL CkHttp_HttpSb(HCkHttp cHandle, const char *verb, const char *url, HCkStringBuilder sb, const char *charset, const char *contentType, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC HCkTask CkHttp_HttpSbAsync(HCkHttp cHandle, const char *verb, const char *url, HCkStringBuilder sb, const char *charset, const char *contentType, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC BOOL CkHttp_HttpSReq(HCkHttp cHandle, const char *domain, int port, BOOL ssl, HCkHttpRequest request, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC HCkTask CkHttp_HttpSReqAsync(HCkHttp cHandle, const char *domain, int port, BOOL ssl, HCkHttpRequest request, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC BOOL CkHttp_HttpStr(HCkHttp cHandle, const char *verb, const char *url, const char *bodyStr, const char *charset, const char *contentType, HCkHttpResponse response);
CK_C_VISIBLE_PUBLIC HCkTask CkHttp_HttpStrAsync(HCkHttp cHandle, const char *verb, const char *url, const char *bodyStr, const char *charset, const char *contentType, HCkHttpResponse response);
...
CK_C_VISIBLE_PUBLIC BOOL CkHttp_S3_DeleteObjects(HCkHttp cHandle, const char *bucketName, HCkStringTable objectNames, HCkJsonObject jsonResponse);
CK_C_VISIBLE_PUBLIC HCkTask CkHttp_S3_DeleteObjectsAsync(HCkHttp cHandle, const char *bucketName, HCkStringTable objectNames, HCkJsonObject jsonResponse);
