...
CK_C_VISIBLE_PUBLIC HCkMailMan CkMailMan_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC void CkMailMan_getSmtpMailFrom(HCkMailMan cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void CkMailMan_putSmtpMailFrom(HCkMailMan cHandle, const char *newVal);
CK_C_VISIBLE_PUBLIC const char *CkMailMan_smtpMailFrom(HCkMailMan cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailMan_AddPfxSourceBd(HCkMailMan cHandle, HCkBinData bd, const char *password);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailMan_DeleteUidlSet(HCkMailMan cHandle, HCkStringTable stUidls);
CK_C_VISIBLE_PUBLIC HCkTask CkMailMan_DeleteUidlSetAsync(HCkMailMan cHandle, HCkStringTable stUidls);
CK_C_VISIBLE_PUBLIC BOOL CkMailMan_FetchAll(HCkMailMan cHandle, BOOL keepOnServer, BOOL headersOnly, int numBodyLines, HCkEmailBundle bundle);
CK_C_VISIBLE_PUBLIC HCkTask CkMailMan_FetchAllAsync(HCkMailMan cHandle, BOOL keepOnServer, BOOL headersOnly, int numBodyLines, HCkEmailBundle bundle);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailMan_FetchByUidl(HCkMailMan cHandle, const char *uidl, BOOL headerOnly, int numBodyLines, HCkEmail email);
CK_C_VISIBLE_PUBLIC HCkTask CkMailMan_FetchByUidlAsync(HCkMailMan cHandle, const char *uidl, BOOL headerOnly, int numBodyLines, HCkEmail email);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailMan_FetchFull(HCkMailMan cHandle, HCkEmail partialEmail, HCkEmail fullEmail);
CK_C_VISIBLE_PUBLIC HCkTask CkMailMan_FetchFullAsync(HCkMailMan cHandle, HCkEmail partialEmail, HCkEmail fullEmail);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailMan_FetchMimeByMsgnumBd(HCkMailMan cHandle, int msgnum, HCkBinData bd);
CK_C_VISIBLE_PUBLIC HCkTask CkMailMan_FetchMimeByMsgnumBdAsync(HCkMailMan cHandle, int msgnum, HCkBinData bd);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailMan_FetchOne(HCkMailMan cHandle, BOOL headerOnly, int numBodyLines, int msgNum, HCkEmail email);
CK_C_VISIBLE_PUBLIC HCkTask CkMailMan_FetchOneAsync(HCkMailMan cHandle, BOOL headerOnly, int numBodyLines, int msgNum, HCkEmail email);
CK_C_VISIBLE_PUBLIC BOOL CkMailMan_FetchRange(HCkMailMan cHandle, BOOL keepOnServer, BOOL headersOnly, int numBodyLines, int startIndex, int endIndex, HCkEmailBundle bundle);
CK_C_VISIBLE_PUBLIC HCkTask CkMailMan_FetchRangeAsync(HCkMailMan cHandle, BOOL keepOnServer, BOOL headersOnly, int numBodyLines, int startIndex, int endIndex, HCkEmailBundle bundle);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailMan_FetchUidls(HCkMailMan cHandle, HCkStringTable uidls);
CK_C_VISIBLE_PUBLIC HCkTask CkMailMan_FetchUidlsAsync(HCkMailMan cHandle, HCkStringTable uidls);
CK_C_VISIBLE_PUBLIC BOOL CkMailMan_FetchUidlSet(HCkMailMan cHandle, HCkStringTable uidls, BOOL headersOnly, int numBodyLines, HCkEmailBundle bundle);
CK_C_VISIBLE_PUBLIC HCkTask CkMailMan_FetchUidlSetAsync(HCkMailMan cHandle, HCkStringTable uidls, BOOL headersOnly, int numBodyLines, HCkEmailBundle bundle);
...
CK_C_VISIBLE_PUBLIC void CkMailMan_GetLastJsonData(HCkMailMan cHandle, HCkJsonObject json);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailMan_GetServerCert(HCkMailMan cHandle, BOOL useSmtp, HCkCert cert);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailMan_LoadMbxFile(HCkMailMan cHandle, const char *mbxPath, HCkEmailBundle bundle);
