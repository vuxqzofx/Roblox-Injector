...
CK_C_VISIBLE_PUBLIC void CkPkcs11W_getUncommonOptions(HCkPkcs11W cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void  CkPkcs11W_putUncommonOptions(HCkPkcs11W cHandle, const wchar_t *newVal);
CK_C_VISIBLE_PUBLIC const wchar_t *CkPkcs11W_uncommonOptions(HCkPkcs11W cHandle);
