...
CK_C_VISIBLE_PUBLIC BOOL CkFileAccessW_DirExists(HCkFileAccessW cHandle, const wchar_t *dirPath);
...
CK_C_VISIBLE_PUBLIC BOOL CkFileAccessW_GetFileTimeStr(HCkFileAccessW cHandle, const wchar_t *path, int which, HCkString outStr);
CK_C_VISIBLE_PUBLIC const wchar_t *CkFileAccessW_getFileTimeStr(HCkFileAccessW cHandle, const wchar_t *path, int which);
