...
class CK_VISIBLE_PUBLIC CkHttpRequest  : public CkMultiByteBase
{
	...
	static CkHttpRequest *createNew2(int progLang);
	...
	// Controls the character encoding used in the URL encoding of query params. The
	// default value of this propoerty is utf-8 .
	...
	// The ContentType property sets the Content-Type header field, and identifies the
	// content-type of the HTTP request body. Common values are:
	// 
	...
	// on the start line of an HTTP request, such as GET, POST, PUT, DELETE, etc. It is
	// also possible to use the various WebDav verbs such as PROPFIND, PROPPATCH,
	...
	// The HTTP version in the request header. Defaults to 1.1 . Can only be set to 1.0
	// or 1.1 .
	...
	// header fields, and (3) the MIME body. This method sets the MIME body.
	// 
	// charset indicates the charset, such as utf-8 or iso-8859-1 , to be used. The HTTP
	// body will contain the bodyStr converted to this character encoding.
	// 
