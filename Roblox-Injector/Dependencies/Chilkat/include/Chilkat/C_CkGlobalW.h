...
CK_C_VISIBLE_PUBLIC BOOL CkGlobalW_getAutoQBDecode(HCkGlobalW cHandle);
CK_C_VISIBLE_PUBLIC void  CkGlobalW_putAutoQBDecode(HCkGlobalW cHandle, BOOL newVal);
