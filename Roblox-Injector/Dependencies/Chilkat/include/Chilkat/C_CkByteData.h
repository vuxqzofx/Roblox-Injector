...
CK_C_VISIBLE_PUBLIC HCkByteData CkByteData_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC const char *CkByteData_getEncoded(HCkByteData cHandle, const char *encoding);
