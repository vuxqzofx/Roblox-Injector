...
CK_C_VISIBLE_PUBLIC void CkSecureStringW_getDebugLogFilePath(HCkSecureStringW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void  CkSecureStringW_putDebugLogFilePath(HCkSecureStringW cHandle, const wchar_t *newVal);
CK_C_VISIBLE_PUBLIC const wchar_t *CkSecureStringW_debugLogFilePath(HCkSecureStringW cHandle);
CK_C_VISIBLE_PUBLIC void CkSecureStringW_getLastErrorHtml(HCkSecureStringW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const wchar_t *CkSecureStringW_lastErrorHtml(HCkSecureStringW cHandle);
CK_C_VISIBLE_PUBLIC void CkSecureStringW_getLastErrorText(HCkSecureStringW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const wchar_t *CkSecureStringW_lastErrorText(HCkSecureStringW cHandle);
CK_C_VISIBLE_PUBLIC void CkSecureStringW_getLastErrorXml(HCkSecureStringW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const wchar_t *CkSecureStringW_lastErrorXml(HCkSecureStringW cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkSecureStringW_getVerboseLogging(HCkSecureStringW cHandle);
CK_C_VISIBLE_PUBLIC void  CkSecureStringW_putVerboseLogging(HCkSecureStringW cHandle, BOOL newVal);
CK_C_VISIBLE_PUBLIC void CkSecureStringW_getVersion(HCkSecureStringW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const wchar_t *CkSecureStringW_version(HCkSecureStringW cHandle);
