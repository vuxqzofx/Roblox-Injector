...
CK_C_VISIBLE_PUBLIC BOOL CkBz2W_CompressBd(HCkBz2W cHandle, HCkBinDataW bd);
CK_C_VISIBLE_PUBLIC HCkTaskW CkBz2W_CompressBdAsync(HCkBz2W cHandle, HCkBinDataW bd);
...
CK_C_VISIBLE_PUBLIC BOOL CkBz2W_UncompressBd(HCkBz2W cHandle, HCkBinDataW bd);
CK_C_VISIBLE_PUBLIC HCkTaskW CkBz2W_UncompressBdAsync(HCkBz2W cHandle, HCkBinDataW bd);
