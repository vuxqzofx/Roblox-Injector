...
class CK_VISIBLE_PUBLIC CkSshKey  : public CkMultiByteBase
{
	...
	static CkSshKey *createNew2(int progLang);
	...
	// Indicates the type of key held in this object instance. Can be rsa , dsa , ecdsa
	// , ed25519 , or none .
	...
	// Loads an SSH certificate into this object. Although an SSH certificate is not a
	// public or private key, it can be used as an SSH key for public key
	// authentication in SSH/SFTP. This allows the use of an SSH certificate in place
	// of a key.
	// 
	// The SSH certificate (user_key-cert.pub) is a text file, just like a regular SSH
	// public key. It follows the same OpenSSH-style format and is Base64-encoded,
	// making it human-readable.
	// 
	// Here’s what an SSH user certificate looks like:ssh-rsa-cert-v01@openssh.com AAAAHHNzaC1yc2EAAAADAQABAAABAQC...AAE= user@host
	// 
	bool UseSshCertificate(const char *sshCert);
