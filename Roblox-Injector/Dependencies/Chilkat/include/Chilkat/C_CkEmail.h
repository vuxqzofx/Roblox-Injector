...
CK_C_VISIBLE_PUBLIC HCkEmail CkEmail_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmail_AddPfxSourceBd(HCkEmail cHandle, HCkBinData bd, const char *password);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmail_GetAttachedEmail(HCkEmail cHandle, int index, HCkEmail email);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmail_GetDigestEmail(HCkEmail cHandle, int index, HCkEmail email);
CK_C_VISIBLE_PUBLIC HCkStringArray CkEmail_GetDsnFinalRecipients(HCkEmail cHandle);
CK_C_VISIBLE_PUBLIC BOOL CkEmail_GetDsnInfo(HCkEmail cHandle, HCkJsonObject json);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmail_GetHtmlBodySb(HCkEmail cHandle, BOOL inlineImageData, HCkStringBuilder sb);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmail_LastDecryptCert(HCkEmail cHandle, HCkCert cert);
CK_C_VISIBLE_PUBLIC BOOL CkEmail_LastSignerCert(HCkEmail cHandle, int index, HCkCert cert);
CK_C_VISIBLE_PUBLIC BOOL CkEmail_LinkedDomains(HCkEmail cHandle, HCkStringTable domains);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmail_MakeCopy(HCkEmail cHandle, HCkEmail destEmail);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmail_SetBodyBd(HCkEmail cHandle, HCkBinData bd, const char *contentType, const char *disposition, const char *filename);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmail_ToDsn(HCkEmail cHandle, const char *explanation, const char *statusFields, BOOL headerOnly, HCkEmail dsnEmail);
CK_C_VISIBLE_PUBLIC BOOL CkEmail_ToForward(HCkEmail cHandle, HCkEmail forward);
CK_C_VISIBLE_PUBLIC BOOL CkEmail_ToMdn(HCkEmail cHandle, const char *message, const char *statusFields, BOOL headerOnly, HCkEmail mdn);
CK_C_VISIBLE_PUBLIC BOOL CkEmail_ToReply(HCkEmail cHandle, HCkEmail reply);
