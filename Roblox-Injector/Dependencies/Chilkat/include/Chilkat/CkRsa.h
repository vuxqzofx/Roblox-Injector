...
class CK_VISIBLE_PUBLIC CkRsa  : public CkMultiByteBase
{
	...
	static CkRsa *createNew2(int progLang);
	...
	// 
	bool GenKey(int numBits, CkPrivateKey &privKey);
