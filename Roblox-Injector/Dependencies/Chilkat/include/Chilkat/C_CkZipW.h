...
CK_C_VISIBLE_PUBLIC void CkZipW_getMaxDate(HCkZipW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void  CkZipW_putMaxDate(HCkZipW cHandle, const wchar_t *newVal);
CK_C_VISIBLE_PUBLIC const wchar_t *CkZipW_maxDate(HCkZipW cHandle);
...
CK_C_VISIBLE_PUBLIC void CkZipW_getMinDate(HCkZipW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void  CkZipW_putMinDate(HCkZipW cHandle, const wchar_t *newVal);
CK_C_VISIBLE_PUBLIC const wchar_t *CkZipW_minDate(HCkZipW cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkZipW_AddBd(HCkZipW cHandle, const wchar_t *pathInZip, HCkBinDataW bd);
CK_C_VISIBLE_PUBLIC BOOL CkZipW_AddEmpty(HCkZipW cHandle, BOOL isDir, const wchar_t *pathInZip);
CK_C_VISIBLE_PUBLIC BOOL CkZipW_AddEncoded(HCkZipW cHandle, const wchar_t *pathInZip, const wchar_t *encoding, const wchar_t *data);
CK_C_VISIBLE_PUBLIC BOOL CkZipW_AddFile(HCkZipW cHandle, const wchar_t *localPath, BOOL saveExtraPath);
CK_C_VISIBLE_PUBLIC void CkZipW_AddNoCompressExtension(HCkZipW cHandle, const wchar_t *fileExtension);
CK_C_VISIBLE_PUBLIC BOOL CkZipW_AddSb(HCkZipW cHandle, const wchar_t *pathInZip, HCkStringBuilderW sb, const wchar_t *charset);
CK_C_VISIBLE_PUBLIC BOOL CkZipW_AddString(HCkZipW cHandle, const wchar_t *pathInZip, const wchar_t *content, const wchar_t *charset);
...
CK_C_VISIBLE_PUBLIC BOOL CkZipW_AppendSb(HCkZipW cHandle, const wchar_t *pathInZip, HCkStringBuilderW sb, const wchar_t *charset);
...
CK_C_VISIBLE_PUBLIC BOOL CkZipW_EntryAt(HCkZipW cHandle, int index, HCkZipEntryW entry);
CK_C_VISIBLE_PUBLIC BOOL CkZipW_EntryById(HCkZipW cHandle, int id, HCkZipEntryW entry);
CK_C_VISIBLE_PUBLIC BOOL CkZipW_EntryMatching(HCkZipW cHandle, const wchar_t *pattern, HCkZipEntryW entry);
CK_C_VISIBLE_PUBLIC BOOL CkZipW_EntryOf(HCkZipW cHandle, const wchar_t *pathInZip, HCkZipEntryW entry);
