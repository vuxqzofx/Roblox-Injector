...
CK_C_VISIBLE_PUBLIC BOOL CkJsonObjectW_AppendArray2(HCkJsonObjectW cHandle, const wchar_t *name, HCkJsonArrayW jarr);
...
CK_C_VISIBLE_PUBLIC BOOL CkJsonObjectW_AppendObject2(HCkJsonObjectW cHandle, const wchar_t *name, HCkJsonObjectW jsonObj);
...
CK_C_VISIBLE_PUBLIC BOOL CkJsonObjectW_ArrayAt2(HCkJsonObjectW cHandle, int index, HCkJsonArrayW jarr);
CK_C_VISIBLE_PUBLIC HCkJsonArrayW CkJsonObjectW_ArrayOf(HCkJsonObjectW cHandle, const wchar_t *jsonPath);
CK_C_VISIBLE_PUBLIC BOOL CkJsonObjectW_ArrayOf2(HCkJsonObjectW cHandle, const wchar_t *jsonPath, HCkJsonArrayW jarr);
...
CK_C_VISIBLE_PUBLIC BOOL CkJsonObjectW_CopyRef(HCkJsonObjectW cHandle, HCkJsonObjectW jsonObj);
...
CK_C_VISIBLE_PUBLIC BOOL CkJsonObjectW_FindObjectWithMember2(HCkJsonObjectW cHandle, const wchar_t *name, HCkJsonObjectW jsonObj);
...
CK_C_VISIBLE_PUBLIC BOOL CkJsonObjectW_FindRecord2(HCkJsonObjectW cHandle, const wchar_t *arrayPath, const wchar_t *relPath, const wchar_t *value, BOOL caseSensitive, HCkJsonObjectW jsonObj);
...
CK_C_VISIBLE_PUBLIC BOOL CkJsonObjectW_GetDocRoot2(HCkJsonObjectW cHandle, HCkJsonObjectW docRoot);
...
CK_C_VISIBLE_PUBLIC BOOL CkJsonObjectW_MakeCopy(HCkJsonObjectW cHandle, HCkJsonObjectW json);
...
CK_C_VISIBLE_PUBLIC BOOL CkJsonObjectW_ObjectAt2(HCkJsonObjectW cHandle, int index, HCkJsonObjectW jsonObj);
CK_C_VISIBLE_PUBLIC HCkJsonObjectW CkJsonObjectW_ObjectOf(HCkJsonObjectW cHandle, const wchar_t *jsonPath);
CK_C_VISIBLE_PUBLIC BOOL CkJsonObjectW_ObjectOf2(HCkJsonObjectW cHandle, const wchar_t *jsonPath, HCkJsonObjectW jsonObj);
