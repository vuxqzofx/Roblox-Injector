...
CK_C_VISIBLE_PUBLIC HCkPdf CkPdf_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC void CkPdf_getOwnerPassword(HCkPdf cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void CkPdf_putOwnerPassword(HCkPdf cHandle, const char *newVal);
CK_C_VISIBLE_PUBLIC const char *CkPdf_ownerPassword(HCkPdf cHandle);
...
CK_C_VISIBLE_PUBLIC void CkPdf_getUserPassword(HCkPdf cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void CkPdf_putUserPassword(HCkPdf cHandle, const char *newVal);
CK_C_VISIBLE_PUBLIC const char *CkPdf_userPassword(HCkPdf cHandle);
...
CK_C_VISIBLE_PUBLIC void CkPdf_GetLastJsonData(HCkPdf cHandle, HCkJsonObject json);
...
CK_C_VISIBLE_PUBLIC BOOL CkPdf_UpdateMetadata(HCkPdf cHandle, HCkStringBuilder sb, const char *outFilePath);
CK_C_VISIBLE_PUBLIC BOOL CkPdf_UpdateMetadataBd(HCkPdf cHandle, HCkStringBuilder sb, HCkBinData bd);
