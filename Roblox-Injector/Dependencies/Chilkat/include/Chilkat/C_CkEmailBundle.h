...
CK_C_VISIBLE_PUBLIC HCkEmailBundle CkEmailBundle_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC void CkEmailBundle_Clear(HCkEmailBundle cHandle);
CK_C_VISIBLE_PUBLIC BOOL CkEmailBundle_EmailAt(HCkEmailBundle cHandle, int index, HCkEmail email);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmailBundle_FindEmail(HCkEmailBundle cHandle, HCkJsonObject json, HCkEmail email);
