...
CK_C_VISIBLE_PUBLIC HCkOAuth2 CkOAuth2_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC BOOL CkOAuth2_getOob(HCkOAuth2 cHandle);
CK_C_VISIBLE_PUBLIC void CkOAuth2_putOob(HCkOAuth2 cHandle, BOOL newVal);
...
CK_C_VISIBLE_PUBLIC BOOL CkOAuth2_ExchangeCodeForToken(HCkOAuth2 cHandle, const char *code);
CK_C_VISIBLE_PUBLIC HCkTask CkOAuth2_ExchangeCodeForTokenAsync(HCkOAuth2 cHandle, const char *code);
CK_C_VISIBLE_PUBLIC BOOL CkOAuth2_GetAccessTokenResponseSb(HCkOAuth2 cHandle, HCkStringBuilder sb);
...
CK_C_VISIBLE_PUBLIC BOOL CkOAuth2_LaunchBrowser(HCkOAuth2 cHandle, const char *url);
