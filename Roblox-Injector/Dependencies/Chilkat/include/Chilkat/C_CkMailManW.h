...
CK_C_VISIBLE_PUBLIC void CkMailManW_getSmtpMailFrom(HCkMailManW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void  CkMailManW_putSmtpMailFrom(HCkMailManW cHandle, const wchar_t *newVal);
CK_C_VISIBLE_PUBLIC const wchar_t *CkMailManW_smtpMailFrom(HCkMailManW cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailManW_AddPfxSourceBd(HCkMailManW cHandle, HCkBinDataW bd, const wchar_t *password);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailManW_DeleteUidlSet(HCkMailManW cHandle, HCkStringTableW stUidls);
CK_C_VISIBLE_PUBLIC HCkTaskW CkMailManW_DeleteUidlSetAsync(HCkMailManW cHandle, HCkStringTableW stUidls);
CK_C_VISIBLE_PUBLIC BOOL CkMailManW_FetchAll(HCkMailManW cHandle, BOOL keepOnServer, BOOL headersOnly, int numBodyLines, HCkEmailBundleW bundle);
CK_C_VISIBLE_PUBLIC HCkTaskW CkMailManW_FetchAllAsync(HCkMailManW cHandle, BOOL keepOnServer, BOOL headersOnly, int numBodyLines, HCkEmailBundleW bundle);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailManW_FetchByUidl(HCkMailManW cHandle, const wchar_t *uidl, BOOL headerOnly, int numBodyLines, HCkEmailW email);
CK_C_VISIBLE_PUBLIC HCkTaskW CkMailManW_FetchByUidlAsync(HCkMailManW cHandle, const wchar_t *uidl, BOOL headerOnly, int numBodyLines, HCkEmailW email);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailManW_FetchFull(HCkMailManW cHandle, HCkEmailW partialEmail, HCkEmailW fullEmail);
CK_C_VISIBLE_PUBLIC HCkTaskW CkMailManW_FetchFullAsync(HCkMailManW cHandle, HCkEmailW partialEmail, HCkEmailW fullEmail);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailManW_FetchMimeByMsgnumBd(HCkMailManW cHandle, int msgnum, HCkBinDataW bd);
CK_C_VISIBLE_PUBLIC HCkTaskW CkMailManW_FetchMimeByMsgnumBdAsync(HCkMailManW cHandle, int msgnum, HCkBinDataW bd);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailManW_FetchOne(HCkMailManW cHandle, BOOL headerOnly, int numBodyLines, int msgNum, HCkEmailW email);
CK_C_VISIBLE_PUBLIC HCkTaskW CkMailManW_FetchOneAsync(HCkMailManW cHandle, BOOL headerOnly, int numBodyLines, int msgNum, HCkEmailW email);
CK_C_VISIBLE_PUBLIC BOOL CkMailManW_FetchRange(HCkMailManW cHandle, BOOL keepOnServer, BOOL headersOnly, int numBodyLines, int startIndex, int endIndex, HCkEmailBundleW bundle);
CK_C_VISIBLE_PUBLIC HCkTaskW CkMailManW_FetchRangeAsync(HCkMailManW cHandle, BOOL keepOnServer, BOOL headersOnly, int numBodyLines, int startIndex, int endIndex, HCkEmailBundleW bundle);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailManW_FetchUidls(HCkMailManW cHandle, HCkStringTableW uidls);
CK_C_VISIBLE_PUBLIC HCkTaskW CkMailManW_FetchUidlsAsync(HCkMailManW cHandle, HCkStringTableW uidls);
CK_C_VISIBLE_PUBLIC BOOL CkMailManW_FetchUidlSet(HCkMailManW cHandle, HCkStringTableW uidls, BOOL headersOnly, int numBodyLines, HCkEmailBundleW bundle);
CK_C_VISIBLE_PUBLIC HCkTaskW CkMailManW_FetchUidlSetAsync(HCkMailManW cHandle, HCkStringTableW uidls, BOOL headersOnly, int numBodyLines, HCkEmailBundleW bundle);
...
CK_C_VISIBLE_PUBLIC void CkMailManW_GetLastJsonData(HCkMailManW cHandle, HCkJsonObjectW json);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailManW_GetServerCert(HCkMailManW cHandle, BOOL useSmtp, HCkCertW cert);
...
CK_C_VISIBLE_PUBLIC BOOL CkMailManW_LoadMbxFile(HCkMailManW cHandle, const wchar_t *mbxPath, HCkEmailBundleW bundle);
