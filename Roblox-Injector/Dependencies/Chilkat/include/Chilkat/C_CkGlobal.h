...
CK_C_VISIBLE_PUBLIC HCkGlobal CkGlobal_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC BOOL CkGlobal_getAutoQBDecode(HCkGlobal cHandle);
CK_C_VISIBLE_PUBLIC void CkGlobal_putAutoQBDecode(HCkGlobal cHandle, BOOL newVal);
