...
CK_C_VISIBLE_PUBLIC void CkEmailBundleW_Clear(HCkEmailBundleW cHandle);
CK_C_VISIBLE_PUBLIC BOOL CkEmailBundleW_EmailAt(HCkEmailBundleW cHandle, int index, HCkEmailW email);
...
CK_C_VISIBLE_PUBLIC BOOL CkEmailBundleW_FindEmail(HCkEmailBundleW cHandle, HCkJsonObjectW json, HCkEmailW email);
