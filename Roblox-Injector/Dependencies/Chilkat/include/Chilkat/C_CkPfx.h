...
CK_C_VISIBLE_PUBLIC HCkPfx CkPfx_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC BOOL CkPfx_CertAt(HCkPfx cHandle, int index, HCkCert cert);
CK_C_VISIBLE_PUBLIC BOOL CkPfx_CertByLocalKeyId(HCkPfx cHandle, const char *localKeyId, const char *encoding, HCkCert cert);
...
CK_C_VISIBLE_PUBLIC void CkPfx_GetLastJsonData(HCkPfx cHandle, HCkJsonObject json);
...
CK_C_VISIBLE_PUBLIC BOOL CkPfx_ImportToKeychain(HCkPfx cHandle, HCkJsonObject opts);
...
CK_C_VISIBLE_PUBLIC BOOL CkPfx_LoadPfxBd(HCkPfx cHandle, HCkBinData bd, const char *password);
...
CK_C_VISIBLE_PUBLIC BOOL CkPfx_PrivateKeyAt(HCkPfx cHandle, int index, HCkPrivateKey privKey);
...
CK_C_VISIBLE_PUBLIC BOOL CkPfx_ToBd(HCkPfx cHandle, const char *password, HCkBinData bd);
...
CK_C_VISIBLE_PUBLIC BOOL CkPfx_ToJksObj(HCkPfx cHandle, const char *alias, const char *password, HCkJavaKeyStore jksObj);
