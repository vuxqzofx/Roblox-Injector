...
CK_C_VISIBLE_PUBLIC void CkSshTunnelW_getClientLogDir(HCkSshTunnelW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void  CkSshTunnelW_putClientLogDir(HCkSshTunnelW cHandle, const wchar_t *newVal);
CK_C_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_clientLogDir(HCkSshTunnelW cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkSshTunnelW_SetAllowedAlgorithms(HCkSshTunnelW cHandle, HCkJsonObjectW json);
