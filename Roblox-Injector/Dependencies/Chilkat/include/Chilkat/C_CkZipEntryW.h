...
CK_C_VISIBLE_PUBLIC BOOL CkZipEntryW_GetNext(HCkZipEntryW cHandle);
CK_C_VISIBLE_PUBLIC BOOL CkZipEntryW_GetNextMatch(HCkZipEntryW cHandle, const wchar_t *pattern);
