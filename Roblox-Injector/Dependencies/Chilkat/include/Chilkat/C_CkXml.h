...
CK_C_VISIBLE_PUBLIC HCkXml CkXml_Create2(int progLang);
...
CK_C_VISIBLE_PUBLIC BOOL CkXml_GetChildWithTag2(HCkXml cHandle, const char *tagPath);
...
CK_C_VISIBLE_PUBLIC BOOL CkXml_SetBinaryContentBd(HCkXml cHandle, HCkBinData data, BOOL zipFlag, BOOL encryptFlag, const char *password);
